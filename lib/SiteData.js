...
export const Project = [
    {
        ...
        keyFeature:"Country Search: Users can search for a specific country by entering its name or selecting from a list. The application retrieves and displays detailed information about the selected country, including its capital, population, area, borders, languages spoken, currencies used, and time zone."
    ...
    },
    {
        ...
        keyFeature:"IP Address Tracking: Users can input an IP address into the application to track its location. The application then retrieves and displays information related to that IP address, including the country, region, city, and geographical coordinates."
    ...
    },
    {
        ...
        keyFeature:"Users can enter a long URL into the application. The system sends a request to the API, which generates a unique, shortened link for the given URL. The shortened link is then displayed to the user, ready for copying and sharing."
    ...
    },
    {
        ...
        keyFeature:"Basic Calculator Functions: The app includes standard calculator functionality, allowing users to perform basic arithmetic operations such as addition, subtraction, multiplication, and division. It provides a clear and intuitive interface for inputting numbers and executing calculations and it also  has multiple colour themes."
    ...
    },
    {
        ...
        difficulty: 'Hard',
        stack:["React.js", "Tailwind Css", "Framer-motion", 'Redux Toolkit'],
        skills:[ "/images/skills/react.png", "/images/skills/scss.png", "/images/skills/tailwind.png" ], 
        Github:"https://github.com/MARVELGARR/Calculator-app", 
        LiveSite:"https://polite-sundae-d772e6.netlify.app/", 
        images:"/images/projects/desktop-design.jpg", 
        description:"The Multi-Themed Calculator App is a mobile application that provides users with a versatile and visually appealing calculator experience. The app offers a range of themes to customize the calculator's appearance, catering to different user preferences and enhancing the overall user experience.",
        keyFeature: " Users are able to see responsive layout for different screen sizes, and also able to add to cart and remove from cart"
    ...
    },
    {
        ...
        difficulty: 'Hard',
        stack:["React.js", "Tailwind Css", "Nextjs", "Framer-motion", 'Redux Toolkit', 'Next-auth'],
        skills:[ "/images/skills/react.png", "/images/skills/scss.png", "/images/skills/tailwind.png" ], 
        Github:"https://github.com/MARVELGARR/commentsection-app", 
        LiveSite:"https://commentsection-app-3fhz-fdmtfi9w3-marvelgarr.vercel.app/", 
        images:"/images/projects/active-states.jpg", 
        description:"A fullstack web application that enable user to share their ideas with other people and also comment on others ideas.",
        keyFeature: " Users are able to login using google or github and also normal login credentials, see responsive layout for different screen sizes, post, delet, reply and edit posts"
